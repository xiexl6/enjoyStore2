...
public class OrderController {
    ...
    public String cancel1(HttpServletRequest request, HttpServletResponse response)  {
        OrderEntiry orderView = orderService.getDetail("1");
    ...
    public String submit1(HttpServletRequest request, HttpServletResponse response){
        OrderEntiry param = orderService.getDetail("1");
        param.setStatus(0);
        orderService.submit(param);

        request.setAttribute("order", param);
        return "/order";
    }
